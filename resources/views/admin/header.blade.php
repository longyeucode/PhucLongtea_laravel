      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="/admin" class="text-nowrap logo-img">
            <img src="{{asset('img/logophuclong.png')}}" width="180" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link btn btn-primary mb-2 text-white" href="/" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
                <span class="hide-menu">Xem trang web</span>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/admin/admin_order_index" aria-expanded="true">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./logout_logon" aria-expanded="false">
                <span>
          ...
          <ul class="navbar-nav">
            ...
            {{-- <li class="nav-item">
              <a class="nav-link nav-icon-hover" href="javascript:void(0)">
                <i class="ti ti-bell-ringing">sss</i>
