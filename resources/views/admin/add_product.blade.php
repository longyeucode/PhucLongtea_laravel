    ...
    <form class="addPro p-5" action="" method="POST" enctype="multipart/form-data">
       ...
       <strong>{{ $message }}</strong>
        ...
        <div class="form-group col-6">
            ...
            <input type="text" class="form-control" name="name" id="ProductName" placeholder="Nhập tên sả phẩm" onkeyup="ChangeToSlug()">
        </div>
        <div class="form-group col-6">
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="sale_price" id="price_sale" class="form-control"
