              ...
              <div class="col-lg-6 ">
                <div class="card-body p-md-5 mx-md-4 ">
                  ...
                  <div class="text-center">
                    ...
                    <h4 class="mt-1 mb-5 pb-1 text-success">Vui lòng nhập code</h4>
             ...
             @endif
                  ...
                  <form method="POST">
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input name="email" type="" id="form2Example11" class="form-control"
                        placeholder="" />
                     
                    </div>
                    <div class="form-outline mb-4">
                      <label class="form-label" for="form2Example11">Code</label>
                      <input name="verification_code" type="number" id="form2Example11" class="form-control"
                        placeholder="" />
